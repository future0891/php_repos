            ...
            var p_re = "<?php echo U('Product/add?pid=');?>";
             ...
             $("#p_content").ajaxSuccess(function(){
                ...
                $("#pic").uploadify({
                    ...
                    'uploader' : '<?php echo U("Public/getImage" , array("session_id"=>session_id() ));?>',
                    'button_image_url':'__APP__',
                    'fileTypeExts' : '*.gif; *.jpg; *.png',
                    'onUploadSuccess' : function(file, data, response) {
                        var resp = "<tr><td><img src='__PUBLIC__/Upload/Thumb/s_"+data + " ' alt='无图片' /></td>";
                        resp +="<td>设置为封面<input type='radio'  name='cover' value=' "+data+" '/><input type='hidden' name='path[]' value ='" +data+"' ></td>";
